...
def load_data(task):
    if task == "test":        
        testPath = os.getcwd() + '/' + dataset_path + 'test/'
...
#            print ("[%02d/%02d]f1: %sf2: %s" % (i, trainlen, f1, f2))
        ...
        if task == "train":
            # Training data
            path1 = os.getcwd() + '/' + dataset_path + 'train/image/'
            path2 = os.getcwd() + '/' + dataset_path + 'train/gt/'
        elif task == "validation":
            ## Validation data
            path1 = os.getcwd() + '/' + dataset_path + 'validation/image/'
            path2 = os.getcwd() + '/' + dataset_path + 'validation/gt/'
